...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://dancewithceech.com/house-dance",
    siteName: "DanceWithCeech",
    images: [{ url: "https://dancewithceech.com/images/styles/house.jpg", width: 1200, height: 630, alt: "House Dance Moves" }],
    type: "website",
  },
  twitter: {
    ...
    title: "House Dance Moves: DanceWithCeech",
    description: "Learn house dance moves step by step. Jacking, footwork, and club dance tutorials from instructor Ceech.",
    images: ["https://dancewithceech.com/images/styles/house.jpg"],
  },
};

export default function HouseDancePage() {
  const posts = getAllPosts().filter((p) => p.category === "house-dance");
  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: "var(--background)", color: "var(--foreground)" }}>
      ...
      <section className="pt-40 pb-12 px-6 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-4">House Dance Moves</h1>
        <p className="text-lg max-w-xl mx-auto" style={{ color: "var(--muted)" }}>
          Fast footwork, jacking, and club grooves rooted in house music culture.
        </p>
      </section>
      ...
      <section className="py-20 px-6" style={{ borderTop: "1px solid #1f1f1f" }}>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-2xl p-8 flex flex-col gap-4" style={{ backgroundColor: "var(--surface)", border: "1px solid #1f1f1f" }}>
            ...
            <p className="text-sm flex-1" style={{ color: "var(--muted)" }}>House dance lives inside the beat. BeatFirst builds that foundation. Free, with no sign-up required.</p>
