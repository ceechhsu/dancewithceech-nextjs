...
description: "Learn the 1990, the iconic breakdancing power move. Master one-handed spinning in a handstand position step-by-step and build the strength every b-boy needs."
---
## Introduction
...
[Watch: Tutorial](https://youtu.be/06sWcQTHiYA)
...
1. Start with a top rock step, moving into a backstep.
2. Place your dominant hand on the ground, fingers spread for stability.
3. Kick your legs up into a handstand position, balancing on your dominant hand.
4. Keep your body straight and tight, with legs together and toes pointed.
5. Begin to spin by pushing off with your free hand and twisting your hips.
6. Maintain balance by adjusting the pressure on your fingers and palm.
7. Keep your eyes focused on a fixed point to maintain orientation.
8. Continue spinning, using your core and legs to control the rotation.
9. To exit, lower your legs back to the ground or transition into another move.
...
- [Mastering the Headspin: A Gravity-Defying Breaking Move](/blog/mastering-the-headspin-a-gravity-defying-breaking-move) — Like the 1990, the headspin is a one-point inversion that requires balancing your entire body weight while sustaining rotation — the core skill set directly transfers.
- [Mastering the Windmill: The Iconic B-Boy Power Move](/blog/mastering-the-windmill-the-iconic-b-boy-power-move) — The windmill is often combined with the 1990 in competitive sets because both moves rely on continuous rotation and shoulder-to-core power.
- [Mastering the Thomas Flare: A Powerful Breaking Move](/blog/mastering-the-thomas-flare-a-powerful-breaking-move) — The flare demands the same full arm extension and hip elevation that the 1990 requires, making the two natural companions in any advanced power move study.
- [Mastering the Backspin: A Fundamental Breaking Power Move](/blog/mastering-the-backspin-a-fundamental-breaking-power-move) — The backspin is commonly used as an entry or exit to the 1990 since both involve sustained floor-level spinning and building rotational momentum.
