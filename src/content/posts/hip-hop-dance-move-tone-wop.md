...
[Watch: Tutorial](https://youtu.be/5XTrPogmIBU)
...
2. Shift your weight to one leg, lifting the other leg slightly off the ground.

3. Take a small step with the lifted leg, bringing it back to the starting position.

4. As you step back, transfer your weight to the other leg, lifting the first leg slightly.

5. Repeat the process, alternating between legs and creating a rhythmic, bouncing motion.

6. Incorporate arm movements, such as swinging or pumping, to add style and energy to the move.
...
- [6 Simple Steps to Learn The Harlem Shake](/blog/harlem-shake) — the Harlem Shake is the Tone Wop's neighborhood sibling — both come from Harlem and share a loose, rhythmic style where the upper body drives the expression.
- [5 Easy Steps to Learn The Bankhead Bounce](/blog/bankhead-bounce) — the Bankhead Bounce is Atlanta's equivalent of the Tone Wop: both are city-specific bounce moves built on a relaxed knee dip and personal flair rather than strict choreography.
- [4 Easy Tips For The BK Bounce](/blog/bk-bounce) — the BK Bounce shares the Tone Wop's foundational step-and-bounce structure, making it easy to alternate between the two when exploring different regional bounce styles.
- [How to Do the Monastery Hip Hop Dance Move](/blog/hip-hop-dance-move-monastery) — the Monastery's rhythmic toe-heel footwork operates at a similar tempo and groove level as the Tone Wop, and both are frequently used in battle and cypher settings.
